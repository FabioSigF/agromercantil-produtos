      ...
      >
        ...
        <div className="w-full sm:w-1/3 flex gap-2 justify-center">
          <button
            ...
            className="mb-2 sm:mb-0 px-3 py-1 bg-yellow-500 text-white rounded hover:bg-yellow-600"
          >
            Editar
          </button>
          <button
            onClick={() => handleRemove(product.id)}
            className="mb-2 sm:mb-0 px-3 py-1 bg-red-600 text-white rounded hover:bg-red-700"
          >
            Remover
          </button>
        </div>
